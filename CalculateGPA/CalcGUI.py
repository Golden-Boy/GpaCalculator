...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_3.setPlaceholderText(_translate("MainWindow", "Current Grade (e.g 75.00%)", None))
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "Target Grade (e.g 80.00%)", None))
